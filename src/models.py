"""Finite ATS-like safety-game structures used by generators and solvers."""
...
class Action:
    ...
    The transition map is keyed by the tuple of participant-local states and
    returns the next tuple for those same participants.
    """
...
@dataclass(frozen=True)
class SafetyGame:
    """A tiny finite safety game with ATS-like shared actions."""
